...
%1) Compute GMST
t.UTC=t.seconds/3600+t.minute/60+t.hour; %UTC in h
% t.UT1=t.UTC+UT1_UTC;
% 
% y = t.year + 2000;
% m = t.month;
...
% t.GMST0=24110.54841+8640184.812866*TJC+0.093104*TJC.^2-6.2E-6*TJC.^3;
% t.GMST=1.02737909350795*(t.UT1*3600)+t.GMST0;
% 
% t.GMSTdeg = (360/86400)*mod(t.GMST,86400);  % Seconds to deg
% t.GMSTrad = t.GMSTdeg*pi/180;
t.GMSTrad=ComputeGMST(t.UTC,t.year,t.month,t.day);


%2) Terrestrial (TRF) to celestial (ECI) transform

for i = 1:length(t.GMSTrad)
