function [results]=RungeKutta(data,prnTarget)
...
for i=1:length(T)
    ...
    for m=1:900
        ...
        f1=[y(4,ti);
            y(5,ti);
            y(6,ti);
            -(e.mu_E/r^2)*(y(1,ti)/r)-(3/2)*e.J2*(e.mu_E/r^2)*(e.R_E^2/r^2)^2*(1-5*(y(3,ti)/r)^2)*(y(1,ti)/r)+a_SM(1);
            -(e.mu_E/r^2)*(y(2,ti)/r)-(3/2)*e.J2*(e.mu_E/r^2)*(e.R_E^2/r^2)^2*(1-5*(y(3,ti)/r)^2)*(y(2,ti)/r)+a_SM(2);
            -(e.mu_E/r^2)*(y(3,ti)/r)-(3/2)*e.J2*(e.mu_E/r^2)*(e.R_E^2/r^2)^2*(1-5*(y(3,ti)/r)^2)*(y(3,ti)/r)+a_SM(3)];
        ...
        f2= [y1(4);
            y1(5);
            y1(6);
            -(e.mu_E/r^2)*(y1(1)/r)-(3/2)*e.J2*(e.mu_E/r^2)*(e.R_E^2/r^2)^2*(1-5*(y1(3)/r)^2)*(y1(1)/r)+a_SM(1);
            -(e.mu_E/r^2)*(y1(2)/r)-(3/2)*e.J2*(e.mu_E/r^2)*(e.R_E^2/r^2)^2*(1-5*(y1(3)/r)^2)*(y1(2)/r)+a_SM(2);
            -(e.mu_E/r^2)*(y1(3)/r)-(3/2)*e.J2*(e.mu_E/r^2)*(e.R_E^2/r^2)^2*(1-5*(y1(3)/r)^2)*(y1(3)/r)+a_SM(3)];
        ...
        f3= [y2(4);
            y2(5);
            y2(6);
            -(e.mu_E/r^2)*(y2(1)/r)-(3/2)*e.J2*(e.mu_E/r^2)*(e.R_E^2/r^2)^2*(1-5*(y2(3)/r)^2)*(y2(1)/r)+a_SM(1);
            -(e.mu_E/r^2)*(y2(2)/r)-(3/2)*e.J2*(e.mu_E/r^2)*(e.R_E^2/r^2)^2*(1-5*(y2(3)/r)^2)*(y2(2)/r)+a_SM(2);
            -(e.mu_E/r^2)*(y2(3)/r)-(3/2)*e.J2*(e.mu_E/r^2)*(e.R_E^2/r^2)^2*(1-5*(y2(3)/r)^2)*(y2(3)/r)+a_SM(3)];
        ...
        f4= [y3(4);
            y3(5);
            y3(6);
            -(e.mu_E/r^2)*(y3(1)/r)-(3/2)*e.J2*(e.mu_E/r^2)*(e.R_E^2/r^2)^2*(1-5*(y3(3)/r)^2)*(y3(1)/r)+a_SM(1);
            -(e.mu_E/r^2)*(y3(2)/r)-(3/2)*e.J2*(e.mu_E/r^2)*(e.R_E^2/r^2)^2*(1-5*(y3(3)/r)^2)*(y3(2)/r)+a_SM(2);
            -(e.mu_E/r^2)*(y3(3)/r)-(3/2)*e.J2*(e.mu_E/r^2)*(e.R_E^2/r^2)^2*(1-5*(y3(3)/r)^2)*(y3(3)/r)+a_SM(3)];
